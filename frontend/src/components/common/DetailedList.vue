...
<template>
  <div>
    <table id="customersTable" class="mt-3">
      ...
      >
        <tr>
          <th scope="col" class="px-3 py-2" @click="sortTableItems(0)">
            Müşteri
          </th>
          <th
            v-if="isHaveAddress"
      ...
      >
        ...
        >
          ...
          <td class="px-3 py-2 text-center">
            {{ customer.net_bakiye.toFixed(2).toString() + " TL" }}
          </td>
          <td class="px-3 py-2 text-center">
            <UDropdownMenu
              arrow
    ...
    <div
      ...
      class="block sm:flex items-center justify-between sm:justify-center my-3 select-none"
    >
      <div
            ...
            >
              ...
              >
                ...
                <UIcon
                  ...
                  :class="{ 'text-black dark:text-white': currentPage !== 1 }"
                />
              </a>
              <a
                v-if="customersPageCount !== 0"
