...
/**
  ...
  *
  * @checksum - 67f0cecafcbec3d3661f19844b90811c635243ac4ed3d19217094d580891236c
  * @variables - radius=rounded,accentColor=violet,colorTemperature=neutral,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
